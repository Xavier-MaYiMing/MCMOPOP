#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2022/7/20 12:17
# @Author  : Xavier Ma
# @Email   : xavier_mayiming@163.com
# @File    : RSA4one_to_all_MCMOPOP.py
# @Statement : The ripple spreading algorithm for the one-to-all multi-category multi-objective path optimization problem
import copy
